      ...
      <div className="container mx-auto flex flex-col justify-center items-center h-full text-center px-4">
        ...
        <div className="flex flex-col md:flex-row justify-around items-center w-full space-y-4 md:space-y-0">
          ...
          <div>
            ...
            <ul>
              <li>
                <a href="https://github.com/jahari11" className="text-white hover:text-gray-400">
                  Github
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/jahari-crawford-young-b11564165/" className="text-white hover:text-gray-400">
                  LinkedIn
                </a>
              </li>
            </ul>
